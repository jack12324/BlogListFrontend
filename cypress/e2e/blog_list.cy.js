describe('Blog app', () => {
  ...
  describe('When logged in', () => {
    ...
    const startingBlogs = [
      {
        title: 'test blog 1', author: 'Testy Joe', url: 'test.com', likes: 0,
      },
      {
        title: 'test blog 2', author: 'Testy Pete', url: 'testy.com', likes: 3,
      },
      {
        title: 'test blog 3', author: 'Testy Mike', url: 'teste.com', likes: 5,
      },
    ];
    ...
    describe('And notes exist', () => {
      ...
      it('the user can not see the remove button if they didn\'t create the note', () => {
        ...
        cy.contains('test blog 3').parent().get('#delete-blog-button').should('not.exist');
      });
      it('blogs are displayed according the the number of likes', () => {
        const sortedStartingItems = startingBlogs.toSorted((a, b) => b.likes - a.likes);
